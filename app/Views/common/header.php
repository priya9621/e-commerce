    ...
    <header class="bottom_headersc">
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light ">
                <a class="navbar-brand" href="<?=base_url()?>"> Micron Shop </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav m-auto">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="<?=base_url()?>orderlist/<?=$category['id']?>"><?=$category['cat_name']?></a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?=base_url()?>orderlist">Mobiles</a>
                    </li>
                    <li class="nav-item">
                  ...
                  <div class="bottom_hiconbox">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">                        
                          <a class="dropdown-item" href="<?=base_url()?>admin/">Profile</a>
                    ...
                    <a style="text-decoration: none; color:black" href="<?=base_url()?>login">Login</a>
                    <?php endif;?>
                  </div>
                </div>
              </nav>
