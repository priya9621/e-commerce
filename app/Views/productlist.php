                ...
                <?php foreach($products as $product):?>   
                    <div class="col-xl-3 col-md-6 col-12">
                        <div class="products_imgbox">
                            ...
                            <!-- <h4>black</h4> -->
                            <h4>₹ <?=$product['selling_price']?> <span><del> ₹ <?=$product['MRP']?></del></span> <span> 4% OFF</span></h4>
                            </a>
                            <div class="products_textbox">
                                ...
                                <div class="products_ulbox">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="<?=base_url()?>product-details/<?=$product['id']?>"><button><svg xmlns="http://www.w3.org/2000/svg" class="products_ulboxicon" fill="currentColor" class="bi bi-cart4" viewBox="0 0 16 16">
