                ...
                <div class="col-xl-9 col-md-12 col-12">
                    <div class="checkout_paymentbox">
                        ...
                        <div class="checkout_paymentbtnsc">
                            <a href="<?=base_url()?>particuler" class="consualt_btn"  data-toggle="modal" data-target="#exampleModal">Add Address</a>
                        </div>
                    </div>
                            ...
                            <div class="col-xl-2 col-md-12 col-12">
                                <div class="cart_leftimgbox">
                                    <div class="cart_leftimgcon">
                                        <img src="<?=base_url()?>public/uploads/iphone 15.jpg" class="cart_leftimg" alt="">
                                    </div>
                    ...
                    <div class="cart_emailbox">
                        ...
                        <a href="<?=base_url()?>success">proceed to pay</a>
                    </div>
